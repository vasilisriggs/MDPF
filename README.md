...
Το **pageSize** ορίζει το μέγιστο μέγεθος που μπορεί να έχει ένα Block σε Bytes. Ο υπολογιστής μπορεί να διαβάζει ένα τέτοιο block κάθε φορά πριν αναγκαστεί να το "πετάξει" από τη μνήμη για να διαβάσει ένα άλλο.
