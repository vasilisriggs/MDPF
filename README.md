...
Κάθε διάσταση έχει ένα **min** και ένα **max**. Το συνολικό εύρος κάθε διάστασης βρίσκεται από τη διαφορά **max-min**. Το εύρος κάθε διάστασης, αν το διαιρέσουμε με τον αριθμό των pages, έχουμε το εύρος που πρέπει να έχει κάθε χωρίο. 
